...
Dimensi = 10
Dimensi2 = 8
Pieces = ['wB', 'bB', 'wK', 'bK', 'wN', 'bN', 'wP', 'bP', 'wQ', 'bQ', 'wR', 'bR', 'wC', 'bC', 'wA', 'bA']
Theme = "Textures/Capablanca Chess/"
PieceNames = {'P': 'Pawn', 'R': 'Rook', 'N': 'Knight', 'B': 'Bishop', 'Q': 'Queen',
              'K': 'King', 'A': 'Archbishop', 'C': 'Chancellor'}
global Promotedpiece


class GameState:
    def __init__(self):
        # papan caturnya, setiap elemen daftar mempunyai 2 karakter, karakter pertama warnanya, kedua tipenya (the board is 10x8, every element has 2 characters, the first one is the color, the second is the type)
        self.board = [
            ["bR", "bN", "bB", "bQ", "bC", "bK", "bA", "bB", "bN", "bR"],
    ...
    def getvalidmoves(self):
        ...
        for i in range(len(moves) - 1, -1, -1):
            ...
            # 3. cek kalo raja kita lg diserang (checks if the king is in danger)
            self.whitetomove = not self.whitetomove
            if self.incheck():
    ...
    def getrookmoves(self, r, c, moves):
        ...
        for d in directions:
            for i in range(1, len(self.board[0])):
                endrow = r + d[0]*i
                endcol = c + d[1]*i
                if 0 <= endrow < len(self.board[0]) and 0 <= endcol < len(self.board[0]) and endrow < 8:
    ...
    def getpromotion(self, move):
        ...
        QW = PhotoImage(file="Textures/Capablanca Chess/Piece Move Diagrams/wQ.png")
        RW = PhotoImage(file="Textures/Capablanca Chess/Piece Move Diagrams/wR.png")
        BW = PhotoImage(file="Textures/Capablanca Chess/Piece Move Diagrams/wB.png")
        KW = PhotoImage(file="Textures/Capablanca Chess/Piece Move Diagrams/wN.png")
        AW = PhotoImage(file="Textures/Capablanca Chess/Piece Move Diagrams/wA.png")
        CW = PhotoImage(file="Textures/Capablanca Chess/Piece Move Diagrams/wC.png")
        QB = PhotoImage(file="Textures/Capablanca Chess/Piece Move Diagrams/bQ.png")
        RB = PhotoImage(file="Textures/Capablanca Chess/Piece Move Diagrams/bR.png")
        BB = PhotoImage(file="Textures/Capablanca Chess/Piece Move Diagrams/bB.png")
        KB = PhotoImage(file="Textures/Capablanca Chess/Piece Move Diagrams/bN.png")
        AB = PhotoImage(file="Textures/Capablanca Chess/Piece Move Diagrams/bA.png")
        CB = PhotoImage(file="Textures/Capablanca Chess/Piece Move Diagrams/bC.png")
        ...
        Button(Window, image=RB if self.whitetomove else RW, command=R, borderwidth=0,
               bg="#202020",
               activebackground="#202020", fg="White").pack()
        Button(Window, image=AB if self.whitetomove else AW, command=AR, borderwidth=0,
               bg="#202020",
               activebackground="#202020", fg="White").pack()
        Button(Window, image=CB if self.whitetomove else CW, command=CH, borderwidth=0,
               bg="#202020",
               activebackground="#202020", fg="White").pack()
...
class Move:
    ...
    def __init__(self, startsq, endsq, board, enpassant=False, castle=False):
        ...
        self.drop = (self.piecemoved == '--' and self.endrow == self.startrow and self.endcol == self.startcol)
