...
Dimensi = 8
Dimensi2 = 8
Pieces = ['wB', 'bB', 'wK', 'bK', 'wN', 'bN', 'wP', 'bP', 'wC', 'bC', 'wR', 'bR']
Theme = "Textures/Almost Chess/"
PieceNames = {'P': 'Pawn', 'R': 'Rook', 'N': 'Knight', 'B': 'Bishop', 'C': 'Chancellor',
              'K': 'King'}
...
class GameState:
    def __init__(self):
        ...
        self.board = [
            ...
            ["wR", "wN", "wB", "wC", "wK", "wB", "wN", "wR"]]
        self.movefunction = {'P': self.getpawnmoves, 'R': self.getrookmoves, 'N': self.getknightmoves,
                             'B': self.getbishopmoves, 'C': self.getchancellormoves, 'K': self.getkingmoves, }
    ...
    def getpromotion(self, move):
        ...
        CW = PhotoImage(file="Textures/Chess/Piece Move Diagrams/wC.png")
        ...
        CB = PhotoImage(file="Textures/Chess/Piece Move Diagrams/bC.png")
